...
![图1. 新闻列表页](http://www.funnycode.net/guet/img/ch06/Code14_running_screenshot.png)
<span id="code14_list"></span>

![图2. 新闻详情页](http://www.funnycode.net/guet/img/ch06/Code14_detail_screenshot.png)
...
![图3. 天行数据官网首页](http://www.funnycode.net/guet/img/ch06/tianapi_index_screenshot.png)
<span id="tianapi_index_page"></span>

![图4. 天行数据控制台](http://www.funnycode.net/guet/img/ch06/tianapi_console_screenshot.png)
...
![图5. 综合新闻API接口文档页](http://www.funnycode.net/guet/img/ch06/tianapi_api_doc.png)
<span id="tianapi_api_doc"></span>

![图6. 综合新闻API在线测试工具](http://www.funnycode.net/guet/img/ch06/tianapi_api_web_tool.png)
...
![图7. 同步项目依赖库](http://www.funnycode.net/guet/img/ch06/Code14_gradle_sync.png)
