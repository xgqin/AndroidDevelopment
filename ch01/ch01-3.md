...
...
    ...
    <TextView
      ...
      <TextView
        ...
        android:layout_width="match_parent"
        android:layout_height="wrap_content"
        android:layout\_below="@id/article\_subheading"
        />
...
```
...
![通过AVD虚拟机运行Code03](https://raw.githubusercontent.com/xgqin/AndroidDevelopment/master/images/ch01/Code03_running.png)
